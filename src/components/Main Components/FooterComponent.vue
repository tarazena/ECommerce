        ...
        <div class="container">
          <div class="row">
            <div class="info col-lg-4">
              <div class="logo"><img src="../../../static/Assets/img/logo-white.png" alt="..."></div>
          ...
          <div class="row d-flex align-items-center">
            ...
            <div class="payment col-md-6 clearfix">
              <ul class="payment-list list-inline-item pull-right">
                <li class="list-inline-item"><img src="../../../static/Assets/img/visa.svg" alt="..."></li>
                <li class="list-inline-item"><img src="../../../static/Assets/img/mastercard.svg" alt="..."></li>
                <li class="list-inline-item"><img src="../../../static/Assets/img/paypal.svg" alt="..."></li>
                <li class="list-inline-item"><img src="../../../static/Assets/img/western-union.svg" alt="..."></li>
              </ul>
            </div>
          </div>
        </div>
